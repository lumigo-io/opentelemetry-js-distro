...
* `LUMIGO_USE_AWS_SDK_INSTRUMENTATION`: `true` by default. Controls the underlying instrumentation used to produce spans (currently affects only SQS calls) when the aws-sdk library (both v2.x and v3.x) is used. Set this to `false` to get those calls instrumented by Lumigo's HTTP instrumentation, to eliminate any potential issues with the [aws-sdk instrumentation](https://github.com/open-telemetry/opentelemetry-js-contrib/tree/main/plugins/node/opentelemetry-instrumentation-aws-sdk).
...
| aws-sdk | [aws-sdk](https://www.npmjs.com/package/aws-sdk) | 2.1533.0~2.1610.0|2.1533.0~2.1610.0|2.1533.0~2.1610.0|2.1533.0~2.1610.0|
...
| | | 5.0.0~5.13.0| 5.0.0~5.13.0| 5.0.0~5.11.0| 5.0.0~5.13.0|
