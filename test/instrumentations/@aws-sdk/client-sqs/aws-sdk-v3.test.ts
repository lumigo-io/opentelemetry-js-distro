...
describe.each(versionsToTest(PACKAGE_NAME, PACKAGE_NAME))(`Instrumentation tests for the ${INSTRUMENTATION_NAME} package`, (versionToTest) => {
  ...
  itTest(
    ...
    async () => {
      ...
      await testApp.invokeGetPath(`/sqs/receive-message?${testAppQueryParams({ region, queueUrl, sqsPort })}`);
