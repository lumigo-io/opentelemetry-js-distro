...
import { SEMATTRS_HTTP_HOST, SEMATTRS_HTTP_TARGET, SEMATTRS_NET_PEER_NAME } from '@opentelemetry/semantic-conventions';
      ...
      safeExecute(() => {
        const requestData: RequestRawData = {
          request: {
            ...
            host: span.attributes?.[SEMATTRS_HTTP_HOST] || span.attributes?.[SEMATTRS_NET_PEER_NAME],
            truncated: false,
            body: '',
